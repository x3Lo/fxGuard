...
<main id="homePage">
    <div id="image">
        <p>Avec fxGuard, gagnez un temps précieux au quotidien.<br><br>Notre solution intelligente prend en charge les tâches chronophages, vous permettant de vous concentrer sur ce qui compte vraiment. Moins de stress, plus d'efficacité, simplifiez-vous la vie avec fxGuard.</p>
