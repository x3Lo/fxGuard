...
Le projet « fxGuard » a vu jour à la demande d'un client, qui souhaitait pouvoir modifier des configurations qui avaient un impact direct dans le jeu. En effet, la modification de contenu apparaissant directement dans le jeu peut s'avérer complexe pour une personne qui ne s'y connaît pas.
